...
//     }
//   }
//   const imageDisplayOptions = createImageDisplayOptions()
//   return (
//     <>
...
const guides: Array<GuideProps> = [
  ...
  },
  {
    ...
    body: 'Enim facilisis gravida neque convallis a cras semper. Suscipit adipiscing bibendum est ultricies integer quis auctor elit sed',
    button: true,
  },
]
...
const createPageWith = (props: GuideProps, OnboardingTheme: any, onTutorialCompleted?: GenericFn) => {
  const { t } = useTranslation()
  const { ColorPallet, ImageTheme } = useTheme()
