  ...
  return (
    <SafeAreaView style={style.container}>
      ...
      <Text style={[style.bodyText, style.bold]}>Last Updated: July 1, 2022</Text>
        ...
        <Text style={style.bodyText}>
          You may delete your Personal Data from your Device at anytime by uninstalling the Holdr+ app or by selecting
          the "Reset Wallet" button in the "Settings" screen.
        </Text>
